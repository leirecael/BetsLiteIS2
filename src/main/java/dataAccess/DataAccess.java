	...
	public void initializeDB(){
		...
		try {
		   ...
		   Team team32= new Team("Federer");
			...
			String apustuMota = "ApustuaEgin";
			
			Transaction t1 = new Transaction(reg1, apA1.getBalioa(), new Date(), apustuMota);
			Transaction t3 = new Transaction(reg2, apA4.getBalioa(), new Date(), apustuMota);
			Transaction t4 = new Transaction(reg3, apA5.getBalioa(), new Date(), apustuMota);
			Transaction t5 = new Transaction(reg4, apA3.getBalioa(), new Date(), apustuMota);
			Transaction t6 = new Transaction(reg4, apA6.getBalioa(), new Date(), apustuMota);
			Transaction t7 = new Transaction(reg1, apA7.getBalioa(), new Date(), apustuMota);
			Transaction t8 = new Transaction(reg1, apA8.getBalioa(), new Date(), apustuMota);
			Transaction t9 = new Transaction(reg2, apA9.getBalioa(), new Date(), apustuMota);
			Transaction t10 = new Transaction(reg2, apA10.getBalioa(), new Date(), apustuMota);
			Transaction t11 = new Transaction(reg3, apA11.getBalioa(), new Date(), apustuMota);
			Transaction t12 = new Transaction(reg3, apA12.getBalioa(), new Date(), apustuMota);
...
public void open(boolean initializeMode){
	...
	public boolean gertaeraopiatu(Event e, Date date) {
		...
		if(query.getResultList().isEmpty()) {
			...
			Event gertKopiatu = new Event(gertaera.getDescription(), date, new Team(taldeak[0]), new Team(taldeak[1]));
	...
	/**
	 * Copies the questions and answers from and event to another
	 * @param gertaera event to copy from
	 * @param gertKopiatu event to paste in
	 */
	private void galderakKopiatu(Event gertaera, Event gertKopiatu) {
		db.getTransaction().begin();
